...
**Enable Unraid’s GraphQL API, create API keys, and use Management Access:** step-by-step guide in the wiki — **[Unraid API and keys](https://github.com/romwil/undockerui/wiki/Unraid-API-and-keys)** (includes links to official Unraid documentation).
